package day06_nestedifElseStatements;

import java.util.Scanner;

public class C01_sifreKonntrolu {
    public static void main(String[] args) {


    /* kullanıcıdan bır sayı isteyin..
        sifre asagıdaki 4 sartı saglıyorsa "Mukammel sayı" yazdırın

        saglanmayan sartlsrın tamamını kullklanıcıya soyleyın
